...
export default function SavedSetsPanel({ currentUser, onRestore }) {
  ...
  if (loading) {
    return <div className="text-xs py-4" style={{ color: '#555' }}>Loading saved sets...</div>
  }
  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        {sets.map(s => (
          <div key={s.id} className="border px-4 py-3 flex items-center justify-between" style={{ borderColor: '#1C1C1C' }}>
